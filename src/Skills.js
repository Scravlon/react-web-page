    ...
    <div className="Skill">
      ...
      <Typist avgTypingDelay={1} stdTypingDelay={18} cursor={{show: true, blink: true,element: '|',hideWhenDone: true,hideWhenDoneDelay: 2000}}>
        ...
        <p className="skillText">
          ...
          &nbsp; String[] tools = &#123;"<font color="red">Android Studio</font>", "<font color="red">Google Cloud API</font>", "<font color="red">Linux</font>", "<font color="red">Microsoft Office</font>", "<font color="red">Remix IDE</font>", "<font color="red">Truffle</font>", "<font color="red">Unity3D</font>" &#125;<br/>
