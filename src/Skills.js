  ...
  return (
    <div className="Skill">
      ...
      <Typist avgTypingDelay={1} stdTypingDelay={18} cursor={{show: true, blink: true,element: '|',hideWhenDone: true,hideWhenDoneDelay: 2000}}>
        ...
        &nbsp; private String[] interest = &#123;"<font color="red">Artificial Intellegence</font>", "<font color="red">Blockchain</font>", "<font color="red">IoT</font>", "<font color="red">Mobile Application development</font>" &#125;<br/>
